...
## Drei grundlegende statistische Verfahren
...
### Verfahren zu statistischen Tests
...
wurde oder nicht.
Wenn wir annehmen bei einem Münzwurf sprechen wir beim Ereignis 'Zahl' von Erfolg,
...
Bedeutet das, dass unsere Nullhypothese von $p=50%$ plausibel ist?
...
**2. Schritt: Formulierung der Nullhypothese $H_0$**
...
liegen wollen wir $H_0$ als falsifiziert betrachten.^[Ganz im Sinne von Popper
...
### Verfahren zur Identifikation von Konfidenzintervallen
...
zusammen, den wir hier verwenden. Einen philosophisch
attraktiveren Weg stellt der
