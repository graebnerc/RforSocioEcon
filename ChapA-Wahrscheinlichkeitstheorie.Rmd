...
Dementsprechend können wir dne Ausdruck für die kumulative Verteilungsfunktion
von oben ergänzen:
...
Wahrscheinlichkeitsfunktion (PMF) | $p(x_k)=\mathbb{P}(X=x_k)$ | NA |
...
dafür brauchen wir Kenntnisse in der Wahrscheinlichkeitsrechnung.
Dann können wir, gegeben unsere Daten, unsere Beschreibung des DGP verfeinern.

Im Großteil dieses Kurses bedeutet das, dass wir für den DGP ein bestimmtes Wahrscheinlichkeitsmodell annehmen und dann auf Basis unserer Daten die Parameter 
