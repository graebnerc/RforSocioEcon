...
```
```{r, echo=FALSE}
development_data <- data.table::fread(here::here("data/tidy/wb_bip_ineq_mort.csv"), 
                          colClasses = c("character", "character", 
                                         rep("double", 5)))
```
...
```{r, echo=FALSE, fig.height=0.5, fig.width=7}
...
knitr::include_graphics(here::here("figures/vis-failes-hanson.png"), auto_pdf = T)
```
...
```{r, echo=FALSE}
hanson_data <- data.table::fread(here::here("data/tidy/hanson-prepared.csv"), 
...
knitr::include_graphics(here::here("figures/vis-failes-oecd.png"), auto_pdf = T)
```
...
```{r, echo=FALSE}
oecd_data <- data.table::fread(here::here("data/raw/oecd_gener_managers.csv")) %>%
  filter(Time==2015) %>%
...
knitr::include_graphics(here::here("figures/vis-fox-news.jpg"), auto_pdf = T)
```
...
```{r,echo=FALSE}
al_daten <- data.table::fread(here::here("data/tidy/al_daten_de.csv"), 
...
knitr::include_graphics(here::here("figures/vis-hb-faz.pdf"), auto_pdf = T)
```
