...
Das geht mit der Funktion `stats::reorder()`, die sie innerhalb der Funktion `aes()` 
anwenden:

<!-- Ist das korrekt dass reorder im Paket stats ist? -->

```{r}
cum_growth_countries_full <- ggplot2::ggplot(
  data = daten_cum_growth) + 
  ggplot2::geom_bar(
    aes(x=stats::reorder(Land, -Wachstum.Land.kum), 
        y=Wachstum.Land.kum), 
...
hässlichen Rändern umgehen, die `ggplot` standardmäßig an beide Enden
