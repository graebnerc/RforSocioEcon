...
ggplot2::ggsave(plot = offenheit_plot, 
       filename = here::here("figures/vis-plot-parts.pdf"), 
       height = 4, width = 6)
ggplot2::ggsave(plot = offenheit_plot, 
       filename = here::here("figures/vis-plot-parts.png"), 
       height = 4, width = 6)
```
...
```{r, echo=FALSE}
gov_trade <- data.table::fread(here::here("data/tidy/government_openness.csv")) %>%
...
knitr::include_graphics(
  path = here::here("figures/chap-vis-chart-selection.jpg"), 
  auto_pdf = T)
```
