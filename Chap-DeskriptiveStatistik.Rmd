...
```{r korrelation, fig.align='center', echo=FALSE, warning=FALSE, message=FALSE}
c0_1a <- -50:50
...
<!-- DISCUSS: Das war im Abschnitt Verteilungen zu formalen Methoden. Sollten wir kurz drüber sprechen wo es besser hinpasst. -->
