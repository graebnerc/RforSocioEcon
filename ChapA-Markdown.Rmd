...
knitr::include_graphics(here("figures/A-Markdown/A-Markdown-NewFile.png"))
```
...
knitr::include_graphics(
  here::here("figures/A-Markdown/A-Markdown-Title.png"))
```
...
```{r, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics(
  here::here("figures/A-Markdown/A-Markdown-Chunk1.png"))
```
...
```{r, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics(
  here::here("figures/A-Markdown/A-Markdown-Chunk3.png"))
```
...
```{r, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics(
  here::here("figures/A-Markdown/A-Markdown-Chunk4.png"))
```
...
knitr::include_graphics(
  here::here("figures/A-Markdown/A-Markdown-Ordnerstruktur.png"))
```
...
`dplyr::select()`).
3. Falls Sie Regressionsoutput in Ihrem Dokument haben: häufig ist der
...
an.
4. Überprüfen Sie ob alle Referenzen (zu Tabellen, Sektionen, etc.) im 
