...
knitr::include_graphics(here("figures/A-Markdown-NewFile.png"))
```
...
```{r, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics(here("figures/A-Markdown-Title.png"))
```
...
```{r, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics(here("figures/A-Markdown-Chunk1.png"))
```
...
```{r, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics(here("figures/A-Markdown-Chunk3.png"))
```
...
```{r, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics(here("figures/A-Markdown-Chunk4.png"))
```
...
knitr::include_graphics(here("figures/A-Markdown-Ordnerstruktur.png"))
```
