...
Ebenfalls häufig verwendet wird die **kumulierte Wahrscheinflichkeitsfunktion**
...
ZV verwendet, wobei das Prinzip das gleiche bleibt.
...
der PMF: wie bekommen die Gesamtwahrscheinlichkeit indem wir die
Wahrscheinlichkeiten für einzelne Events addieren und die Einzelgewichte indem
wir uns die Mass der einzelnen Teile ansehen.
...
Wie oben beschrieben können wir die Werte an einzlnen Punkten der PDF nicht als
...
Die Verteilungen, die wir bisland kennen gelernt haben beschreiben alle die 
...
Grafisch könnten wir die gemeinsame PDF als Quadrad darstellen 
...
Für den diskreten Breich übersetzt sich das konkret in:
...
Sind wir z.B. an der Wahrscheinleichkeit für Schnee interessiert, gegeben dass
...
(wie den Erwartungswert oder die Varianz)nformulieren. 
...
Für den Fall zweier Würfen ist das nichts anderes aus das Summieren der 
...
immer *mean independence* bvorliegt (der umgekehrte Fall gilt jedoch nicht!).
