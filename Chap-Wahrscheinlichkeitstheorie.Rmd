...
```{r Poisson, warning=FALSE, fig.align='center', echo=FALSE, fig.height=2, fig.cap="Poisson-Verteilung für verschiedene Parameter."}
x_range <- 0:18
...
```{r PoissonBsp, warning=FALSE, fig.align='center', echo=FALSE, fig.height=2, fig.cap="Poisson-Verteilung mit ausgewählten Parameterwerten."}
x_range <- 0:18
x_val <- 5
...
ggplot(data.frame(x = x_vals, y=dunif(x_vals, min = x_min, max = x_max))) +
  ...
  theme_bw() + theme(axis.line = element_line(), panel.border = element_blank())
```
