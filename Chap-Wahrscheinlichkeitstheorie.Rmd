...
y_vals_pdf <- data.frame(
  ...
  cols = -x, names_to = "Parameter", values_to = "y")
...
pdf_plot <- ggplot2::ggplot(y_vals_pdf, 
  ...
  ggplot2::scale_y_continuous(
    expand = expansion(c(0, 0.1), c(0, 0.1))
    ) +
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/pmf.png")
save_pdf_png(
  filename = plot_file, plot = pdf_plot, 
  width = 6, height = 3)
```

```{r Binomialverteilung, echo=FALSE, fig.cap="Die Wahrscheinlichkeitsverteilung der Binomialverteilung für verschiedene Parameterwerte."}
...
bin_dist_plot <- ggplot2::ggplot(
  data.frame(
    x = x_vals, 
    y=dbinom(x_vals, anzahl_versuche, 0.25))
  ) +
  ggplot2::geom_line(aes(x=x, y=y)) +
  ggplot2::ylab(TeX("Wahrscheinlichkeit $P(X=x)$")) +
  ggplot2::xlab("Anzahl Erfolge (x)") +
  ggplot2::scale_y_continuous(
    expand = expansion(c(0, 0), c(0, 0.05))) + 
  ggplot2::scale_x_continuous(
    expand = c(0, 0), breaks = x_vals, limits = c(0, 30)) +
  ggplot2::ggtitle(
    TeX("Binomialverteilung mit $p=0.25$ und $n=50$")) +
  ggplot2::geom_segment(
    aes(x = x_val, y = 0, xend = x_val, yend = y_val),
    colour = "#800080") +
  ggplot2::geom_segment(
    aes(x = 0, y = y_val, xend = x_val, yend = y_val),
    colour = "#800080") +
  ggplot2::geom_segment(
    aes(x = 3, y = y_val+0.01, xend = 0, yend=y_val+0.0001),
    arrow = arrow(length = unit(0.03, "npc")),
    colour = "#800080") +
  ggplot2::annotate(
    "text", x = 4, y =0.1125, label = "0.098", colour = "#800080") +
  theme_icae() +
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/binominalvert.png")
save_pdf_png(
  filename = plot_file, plot = bin_dist_plot, 
  width = 6, height = 3)
```

```{r bspbinverteilung, echo=FALSE, fig.cap="Beispiel einer Binomialverteilung mit $p$=0.25 und $n$=50."}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
cdf_bin_plot <- ggplot2::ggplot(
  data.frame(x = x_vals, y=pbinom(x_vals, anzahl_versuche, 0.25))
  ) +
  ggplot2::geom_line(aes(x=x, y=y)) +
  ...
  ggplot2::scale_x_continuous(
    expand = c(0, 0), breaks = x_vals, limits = c(0, 30)) +
  ggplot2::ggtitle(
    TeX("Kumulierte Wahrscheinlichkeitsfunktion der Binomialverteilung ($p=0.25$, $n=50$)")
    ) +
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/cdf_bin.png")
save_pdf_png(
  filename = plot_file, plot = cdf_bin_plot, 
  width = 6, height = 3)
```

```{r kumulativ, echo=FALSE, fig.cap="Kumulative Wahrscheinlichkeitsfunktion mit $p$=0.25 und $n$=50"}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
cdf_inv_plot <- ggplot2::ggplot(
  data.frame(x = p_vals, y=qbinom(p_vals, anzahl_versuche, 0.25))
  ) +
  ggplot2::geom_line(aes(x=x, y=y)) +
  ggplot2::ylab(TeX("Wahrscheinlichkeit $P(X\\leq x)$")) +
  ggplot2::xlab("Anzahl Erfolge (x)") +
  ...
  ggplot2::ggtitle(
    TeX("Invertierte CDF der Binomialverteilung mit $p=0.25$ und $n=50$")
    ) +
  ggplot2::geom_segment(aes(x = x_val, y = 0,
                   xend = x_val, yend = y_val),
               colour = "#800080") +
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/cdf_bin_inv.png")
save_pdf_png(
  filename = plot_file, plot = cdf_inv_plot, 
  width = 6, height = 3)
```

```{r qbinom, echo=FALSE, fig.cap="Graph der invertierten kumulierten Wahrscheinlichkeitsfunktion der Binomialverteilung mit $p=0.25$ und $n=50$"}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
munzwurfe_plot <- ggplot2::ggplot(
  data.frame(x=munzwurfe), aes(x=x)
  ) +
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/muenzwuerfe.png")
save_pdf_png(
  filename = plot_file, plot = munzwurfe_plot, 
  width = 6, height = 3)
```

```{r Munzwurf, echo=FALSE, fig.cap = "Histogram für einen Münzwurf."}
knitr::include_graphics(plot_file, auto_pdf = T)
```
  ...
  ggplot2::geom_line(
    data = data.frame(
      ...
      y=dbinom(seq(0, max(munzwurfe), 1), 
               prob = p_zahl, 
               size = wurfe_pro_experiment)*wurzanzahl), 
    aes(x=x, y=y, color="Theoretische Verteilung"), 
    alpha=0.5, lwd=1
    ) +
  ggplot2::scale_y_continuous(expand = expansion(c(0,0), c(0,1))) +
  icaeDesign::theme_icae() +
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/muenzwuerfe_2.png")
save_pdf_png(
  filename = plot_file, plot = munzwurf_plot_2, 
  width = 6, height = 3)
```

```{r Munzwurfverteilung, echo=FALSE, fig.cap="Vergleich der empirischen Stichprobe und der parametrisierten theoretischen Binomialverteilungsfunktion"}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
poisson_plot <- ggplot2::ggplot(lambdas) +
  ...
  ggplot2::guides(
    color = guide_legend(title = TeX("$\\lambda$"), 
                         title.position = "top")
    ) + 
  icaeDesign::theme_icae() +
  ggplot2::theme(
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/poisson.png")
save_pdf_png(
  filename = plot_file, plot = poisson_plot, 
  width = 6, height = 3)
```

```{r Poisson, echo=FALSE, fig.cap="Poisson-Verteilung für verschiedene Parameter."}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
poisson_plot_2 <- ggplot2::ggplot(lambda_4) +
  ggplot2::geom_point(aes(x=x, y=y, color=lambda, group=lambda)) +
  ggplot2::geom_line(aes(x=x, y=y, color=lambda, group=lambda)) + 
  ggplot2::scale_y_continuous(expand = expansion(c(0,0), c(0,0.025))) +
  ggplot2::scale_x_continuous(expand = expansion(c(0,0), c(0,0))) +
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/poisson_2.png")
save_pdf_png(
  filename = plot_file, plot = poisson_plot_2, 
  width = 6, height = 3)
```

```{r PoissonBsp, warning=FALSE, echo=FALSE, fig.cap="Poisson-Verteilung mit ausgewählten Parameterwerten."}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
poisson_cdf_plot <- ggplot2::ggplot(
  data.frame(x = x_vals, y=ppois(x_vals, lambda = lambda_val))
  ) +
  ggplot2::geom_line(aes(x=x, y=y)) +
  ggplot2::ylab(TeX("Wahrscheinlichkeit $P(X\\leq x)$")) +
  ggplot2::xlab("x") +
  ggplot2::scale_y_continuous(
    expand = expansion(c(0, 0), c(0, 0.05))) + 
  ggplot2::scale_x_continuous(
    expand = c(0, 0), breaks = x_vals, limits = c(0, 15)
    ) +
  ggplot2::ggtitle(
    TeX("CDF der Poisson-Verteilung mit $\\lambda = 4$")) +
  ggplot2::geom_segment(aes(x = x_val, y = 0,
                   xend = x_val, yend = y_val),
               colour = "#800080") +
  ggplot2::geom_segment(aes(x = 0, y = y_val,
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/poisson_cdf.png")
save_pdf_png(
  filename = plot_file, plot = poisson_cdf_plot, 
  width = 6, height = 3)
```

```{r PoissonCDF, warning=FALSE, fig.align='center', echo=FALSE, fig.cap="Kumulierte Wahrscheinlichkeitsfunktion der Poisson-Verteilung mit $\\lambda = 4$"}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
poisson_cdf_inv_plot <- ggplot2::ggplot(
  data.frame(x = p_vals, y=qpois(p_vals, lambda_val))
  ) +
  ggplot2::geom_line(aes(x=x, y=y)) +
  ...
  ggplot2::scale_x_continuous(expand = c(0, 0), breaks = p_vals_breaks) +
  ggplot2::ggtitle(
    TeX("Invertierte CDF der Poisson-Verteilung mit $\\lambda = 4$")) +
  ggplot2::geom_segment(aes(x = x_val, y = 0,
                   xend = x_val, yend = y_val),
               colour = "#800080") +
  ggplot2::geom_segment(aes(x = 0, y = y_val,
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/poisson_cdf_inv.png")
save_pdf_png(
  filename = plot_file, plot = poisson_cdf_inv_plot, 
  width = 6, height = 3)
```

```{r PoissonCDFinv, warning=FALSE, fig.align='center', echo=FALSE, fig.cap="Invertierte CDF der Poisson-Verteilung mit $\\lambda = 4$"}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
q05_plot <- ggplot2::ggplot(
  data.frame(x = x_vals, y=dnorm(x_vals, mean=0, sd=1))
  ) +
  ggplot2::geom_line(aes(x=x, y=y)) +
  ...
  ggplot2::scale_x_continuous(expand = c(0, 0)) +
  ggplot2::ggtitle(
    TeX("Dichte der Normalverteilung mit $\\mu = 0$ und $\\sigma = 1$")) +
  ggplot2::stat_function(
    fun = dnorm, xlim = c(-4, quant_05), geom = "area", 
...
q025_plot <- ggplot2::ggplot(
  ...
  ggplot2::ggtitle(
    TeX("Dichte der Normalverteilung mit $\\mu = 0$ und $\\sigma = 1$")) +
  ggplot2::stat_function(
    fun = dnorm, xlim = c(-4, quant_025), geom = "area", 
...
q_plot_full <- ggpubr::ggarrange(
  q05_plot, q025_plot, ncol = 2, labels = c("a)", "b)"))
```

```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/quantile_plot.png")
save_pdf_png(
  filename = plot_file, plot = q_plot_full, 
  width = 8, height = 3)
```

```{r quantile, warning=FALSE, echo=FALSE, out.width="100%", fig.cap="Vergleich des $0.25$- und $0.5$-Quantils"}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
dichteuniform_plot <- ggplot(
  data.frame(x = x_vals, y=dunif(x_vals, min = x_min, max = x_max))) +
  geom_line(aes(x=x, y=y)) +
  ylab(TeX("$P(x)$")) +
  xlab("x") +
  scale_y_continuous(
    limits = c(0,1), expand = expansion(c(0, 0), c(0, 0.05))) + 
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/pdf_uniform.png")
save_pdf_png(
  filename = plot_file, plot = dichteuniform_plot, 
  width = 6, height = 3)
```
...
cdf_uniform_plot <- ggplot2::ggplot(
  data.frame(x = x_vals, y=dunif(x_vals, min=x_min, max=x_max))) +
  ggplot2::ylab(TeX("$P(x)$")) +
  ggplot2::xlab("x") +
  ggplot2::scale_y_continuous(
  ...
  ggplot2::scale_x_continuous(#
    breaks = x_vals, limits = c(x_min, x_max), expand = c(0, 0)) +
  ggplot2::ggtitle(
    TeX("CDF der Uniformverteilung mit $a = 0$ und $b = 1$")) +
  ...
  ggplot2::annotate("text",
           ...
           colour = "steelblue") +
  icaeDesign::theme_icae() +
  ggplot2::theme(axis.line = element_line(), panel.border = element_blank())
```

```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/cdf_uniform.png")
save_pdf_png(
  filename = plot_file, plot = cdf_uniform_plot, 
  width = 6, height = 3)
```

```{r CDFuniform, warning=FALSE, echo=FALSE, fig.cap="CDF der Uniformverteilung mit $a = 0$ und $b = 1$"}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
pdf_plot <- ggplot2::ggplot(y_vals_pdf, 
  ...
  viridis::scale_color_viridis(
    discrete = T,
    labels = unname(TeX(
      c("$\\mu = 0, \\sigma = 0.25", "$\\mu = 0, \\sigma = 1", 
        "$\\mu = 0, \\sigma = 2", "$\\mu = 2, \\sigma = 1")))
    ) +
  ggplot2::theme(
    legend.position = "bottom", legend.title = element_text(hjust = 0.5),
    axis.line = element_line(), panel.border = element_blank())
...
full_plot <- ggpubr::ggarrange(
  pdf_plot, cdf_plot, ncol = 2, labels = c("a)", "b)"),
  legend = "bottom", common.legend = T)
```

```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/normalverteilung.png")
save_pdf_png(
  filename = plot_file, plot = full_plot, 
  width = 8, height = 3)
```

```{r PDFCDFnormal, echo=FALSE, out.width="100%", fig.cap="Vergleich der PDF und CDF der Normalverteilung."}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
```{r, echo=FALSE}
plot_file <- here::here(
  "figures/Wahrscheinlichkeitstheorie/exponentialverteilung.png")
save_pdf_png(
  filename = plot_file, plot = full_plot, 
  width = 8, height = 3)
```

```{r PDFCDFexponential, echo=FALSE, fig.cap="Beispielhafter Vergleich einer PDF und CDF bei Exponentialverteilung"}
knitr::include_graphics(plot_file, auto_pdf = T)
```
...
knitr::include_graphics(
  here::here("figures/Wahrscheinlichkeitstheorie/continuous_joint_dist.pdf"))
```
