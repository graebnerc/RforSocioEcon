...
Im Folgenden gebe ich einen kurzen Überblick über die Gründe, in diesem Buch spezifisch die Programmiersprache R für sozio-ökonomische Forschung vorzustellen. Die Liste ist sicherlich nicht 
...
* R ist eine offene und freie Programmiersprache, die auf allen bekannten 
  ...
  Im Gegensatz dazu stehen Programme wie SPSS und STATA, für die Universitäten jedes 
...
Workflow. Beispielsweise ist es mit R Markdown möglich, das Coding und Schreiben der Antworten im gleichen Dokument 
vorzunehmen. 
Auch dieses Skript wurde vollständig in R Markdown geschrieben.

<!-- * R erlaubt sowohl objektorientierte als auch funktionale Programmierung. Hier das würde ich noch weiter Erklären. -->
...
Meiner Meinung nach hilft `tidyverse` allerdings bei der Einsteigerfreundlichkeit, da diese Pakete die Arbeit mit Datensätzen sehr 
einfach machen. Für kleine Datensätze (<500MB) benutze ich das `tidyverse` auch in
