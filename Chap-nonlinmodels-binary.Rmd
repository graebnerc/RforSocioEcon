...
<!--
@Birte: hier hab ich was zur Auswahl ergänzt.
-->
...
<!--
Habe oben was ergänzt und den Satz rausgenommen. Unten wird jetzt beides erläutert
-->
...
<!--
Habe ich entsprechend oben und unten ergänzt, sollte jetzt klar sein?
-->
...
<!--
@Birte: ist ja sicher nicht der entgültige Abschluss, deswegen habe ich es mal 
so  formuliert. Passt das?
-->
...
wertvoll ist: viele komplexe Schätzer inkludieren diverse Transformation, können
aber an irgendeinem Punkt auf die OLS-Methode (oder, wie sie dann oft bezeichnet
wird, die *Least Squares*-Methode) zurückgeführt werden.
...
der *Generalized Methods of Momements*-Ansatz oder die zahlreichen
nicht-parametrischen Methoden, mit denen wir uns bisland noch gar nicht 
