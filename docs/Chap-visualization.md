...
\begin{center}\includegraphics[width=0.5\linewidth,height=0.5\textheight]{Chap-visualization_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
ameco_data <- data.table::fread(here::here("data/raw/AMECO16.TXT"), fill = T, header = T) %>%
  ...
  tidyr::pivot_longer(names_to = "Jahr", values_to = "Wert", cols = -UNIT) %>%
...
{\centering \includegraphics[width=0.75\linewidth,height=0.75\textheight]{/Volumes/develop/packages/RforSocioEcon/figures/vis-hb-faz} 
