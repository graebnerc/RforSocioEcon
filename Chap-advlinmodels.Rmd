...
ANTWORT: Habe sie mal gecheckt im code, und zumindest hier sieht alles gut aus. An 2 Stellen gab es noch Referenzen zum Anhang in diesem Format: [im Anhang](#advlin-proofs), also mit eckigen Klammern und dann #. Die habe ich jetzt auch in der format "im Anhang \@ref(advlin-proofs)" umgeändert. korrekt? oder sollte das für die anhangreferenz in diesem alten format bleiben?
-->
...
<!-- 
@Birte: Bitte diesen neuen Teil auch nochmal besonders checken. ANTWORT: find
es super so. nur beim letzten satz mit bootstrap und Huber schätzer vllt noch ne quelle hinzufügen?
-->
