...
<!-- Das ist ein guter Punkt den ich eigentlich aus der Fußnote raus und in den Text setzen würde -->
...
<!-- Werden IVs in diesem Buch noch behandelt? Sonst halbsatz oben raus -->
...
<!-- Falls das im nächsten Kapitel/diesem Buch nicht mehr angesprochen wird vllt hier eine Fußnote setzen mit weiterführender Literatur oder so? -->
...
<!-- Info: ich hab hier beim vorigen chunk mal echo=FALSE eingesetzt, weil hier ja eigl nur der plot wichtig ist und nicht der code. passt? -->
