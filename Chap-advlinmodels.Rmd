...
<!-- @Birte: habe folgenden Kommentar implementiert. Bitte checken, wenn es passt löschen  -->
...
<!-- 
@Birte: bitte nächsten Absatz checken.
-->
...
Erwartungswert des OLS-Schätzers aussagen. Allerdings gilt die Erwartungstreue
...
über die einzelne Schätzung. Auf die Eigenschaft der Effizienz ist hier nur
...
<!-- 
@Birte: Bitte diesen neuen Teil auch nochmal besonders checken.
-->
...
Bei Plot `b)` in Abbildung \@ref(fig:QQPlot) ist das dagegen nichtt der Fall, 
...
Bleibt das erfolglos oder macht wegen dem Anwendungsfall keinen Sinn sollten 
Sie die Unsicherheit Ihrer Schätzung nicht über die 
