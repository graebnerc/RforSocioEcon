...
tk_plot_homo <- ggplot(
  ...
  ggtitle("TK-Plot (homoskedastische Daten)") +
  theme_icae()
```
...
tk_plot_hetero <- ggplot(
  ...
  geom_point(alpha=0.5) +
  geom_hline(yintercept = 0) +
  ggtitle("TK-Plot (heteroskedastische Daten)") +
  theme_icae()
```
...
tk_plot_small <- ggplot(
  ...
  geom_point(alpha=0.5) +
  geom_hline(yintercept = 0) +
  ggtitle("TK-Plot (keine Autokorrelation)") +
  theme_icae()
...
tk_plot_mid <- ggplot(
  ...
  geom_point(alpha=0.5) +
  geom_hline(yintercept = 0) +
  ggtitle("TK-Plot (mittlere Autokorrelation)") +
  theme_icae()
...
tk_plot_large <- ggplot(
  ...
  geom_point(alpha=0.5) +
  geom_hline(yintercept = 0) +
  ggtitle("TK-Plot (starke Autokorrelation)") +
  theme_icae()
