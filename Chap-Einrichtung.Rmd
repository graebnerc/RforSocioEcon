...
<!-- Nur kurz zur Erinnerung: Im ersten Kapitel steht auch schon etwas ähnliches: "Beispielsweise ist es mit R Markdown möglich, das Coding und Schreiben der Antworten im gleichen Dokument vorzunehmen. Auch dieses Skript wurde vollständig in R Markdown geschrieben." Glaube stilistisch sind Wiederholungen meistens nicht so schön, aber vielleicht haben neue Leser*innen das auch schon wieder vergessen und es ist nützlich das nochmal zu erwähnen. Wollte nur darauf hinweisen für den Fall dass die Wiederholung keine bewusste Entscheidung war. -->
