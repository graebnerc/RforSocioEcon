...
Wenn wir in die Konsole z.B. `2+2` eingeben, dann ist das ein valider R Code. 
<!-- Hier bin ich mir nicht sicher, ob man im deutschen sagt "ein valider Code" oder einfach  -->
<!-- nur "das ist valider Code",aber ich habe jetzt einfach mal ein "ein" hinzugefügt. -->
<!-- Außerdem war ich mir nicht sicher bei groß- und kleinschreibung von Code, aber da -->
<!-- du es unten oft groß geschrieben hast, habe ich das hier übernommen. -->
...
<!-- Hier würde ich eventuell auch nochmal einen Hinweis machen, dass es im Anhang ein  -->
<!-- Kapitel zu Git und Github gibt, oder? -->
